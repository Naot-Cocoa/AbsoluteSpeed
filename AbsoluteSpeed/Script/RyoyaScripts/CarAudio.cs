...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private bool m_StartedSound; // 音を再生しているかどうかのフラグ
        ...
        private void Update()
        {
            if (mGameSceneManager.SceneState == SceneState.REPLAY) { StopSound(); return; }//リプレイ時音ならない
            // プレイヤーとの距離を測る
            float camDist = (m_Player.transform.position - transform.position).sqrMagnitude;

            // プレイヤーが最大距離を超えている場合に音を止める
